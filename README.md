## About the cloned experiment

We want to experiment with using OTP's raptor implementation as as standalone library.

### Step 1: Use RaptorService (API) with simple example

__Goal:__  Execute a few queries on the OTP Raptor API. Try to load time table data via GTFS import.
